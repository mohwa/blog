...
- ###그밖의 테스트
  ...
  - <span style="color:#c11f1f">super</span> 키워드를 통해, 부모 클래스에 정의된 <span style="color:#c11f1f">프로토타입</span> 및 <span style="color:#c11f1f">정적</span> 메서드를 <span style="color:#c11f1f">호출</span>할 수 있다.
          ...
          class B extends class A{
              ...
              constructor(id, name){
                  ...
                  // super 키워드를 통해 부모 클래스에 정의된 프로토타입 메서드를 호출할 수 있다.(정적 메서드는 접근할 수 없다)
                  console.log(super.parentPrototypeMethod()); // callPrivateMethod
              ...
              static staticMethod(){
                  // super 키워드를 통해 부모 클래스에 정의된 정적 메서드를 호출할 수 있다.(프로토타입 메서드는 접근할 수 없다)
                  console.log(super.parentStaticMethod()); // callStaticMethod
              }
          };
          
          var newBObject = new B('yanione', 'mohwa');
          // 프로토타입 메서드 호출
          newBObject.prototypeMethod();
