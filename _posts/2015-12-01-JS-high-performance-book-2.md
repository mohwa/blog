...
- <h3>원글: <em><strong>DOM</strong>이란? XML 문서와 HTML 문서에서 동작하는 언어 독립적인 API(Application Programing language) 입니다.</em></h3>

  - **DOM** 이란? 모든 언어(**JavaScript** 등)를 통해 **구현** 가능한 **Programing Interface** 이다.<p />
