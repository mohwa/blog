...
##2. <span style="color:#c11f1f">ES5</span> & <span style="color:#c11f1f">const</span>
...
- ###Object.<span style="color:#c11f1f">defineProperty</span> or <span style="color:#c11f1f">create</span> 메서드를 통해, <span style="color:#c11f1f">읽기전용</span> 속성을 생성할 수 있다(단 일반적인 방법으로 (속성)**값**을 <span style="color:#c11f1f">재 할당</span>시 <span style="color:#c11f1f">const</span> 키워드와 같은 예외가 발생하지는 않는다)
      ...
      ```
- ###Object.<span style="color:#c11f1f">defineProperty</span> 메서드를 통해, <span style="color:#c11f1f">읽기 전용</span> 속성을 <span style="color:#c11f1f">재 정의</span> 시 <span style="color:#c11f1f">const</span> 키워드와 유사한 <span style="color:#c11f1f">예외</span>가 발생하게된다.
      ...
      // 단 Object.defineProperty 메서드를 통해 읽기 전용 속성을 재 정의 시 const 키워드와 유사한 예외가 발생하게된다.
      try{
...
##2. <span style="color:#c11f1f">ES6</span> & <span style="color:#c11f1f">const</span>
